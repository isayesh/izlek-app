...
export default function Register() {
  ...
  const { currentUser, signup, firebaseConfigured } = useAuth();
      ...
      <Card className="w-full max-w-md shadow-lg " data-testid="register-card">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow-md rounded-xl transition-all active:scale-[0.99]" 
              disabled={loading}
