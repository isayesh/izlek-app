                ...
                <div className="-mt-12 flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex items-start gap-3.5 sm:gap-4">
                    ...
                    <div className="pt-8 sm:pt-9">
                      <p className="text-2xl font-bold leading-tight tracking-tight text-foreground">{profile.displayName}</p>
                      <p className="text-xs text-muted-foreground sm:text-sm">@{profile.username}</p>
                    </div>
                  </div>

                  <div className="flex flex-wrap gap-2 sm:mt-9">
                    <Button
                      type="button"
