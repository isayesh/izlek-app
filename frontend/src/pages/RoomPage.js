...
export default function RoomPage() {
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-6 sm:px-6 lg:px-10 xl:px-12 flex h-screen flex-col overflow-hidden" data-testid="room-page">
      ...
      <div className="grid h-full w-full flex-1 min-h-0 gap-6 overflow-hidden grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr]" data-testid="room-main-grid">
