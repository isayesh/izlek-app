...
agent_communication:
  ...
  - agent: "main"
    message: "Requesting frontend verification for Dashboard weekly day selector only. Validate tablet (768/820/1024) and desktop (1280+) that day tabs remain single-row, equal-width, no overlap, no overflow, and no horizontal scroll. UI-only change in Dashboard.js."
